...
export default function FirmDetail() {
  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-neutral-600">{firm.location}</p>
      <p className="text-neutral-600">{firm.description}</p>
      {firm.website_url && <a href={firm.website_url} className="text-sm text-beacon">{firm.website_url}</a>}
